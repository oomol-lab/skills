...
```bash
oo connector schema "cal" --action "create_event_type"
```

## Run

```bash
oo connector run "cal" --action "create_event_type" --data '{}' --json
```
