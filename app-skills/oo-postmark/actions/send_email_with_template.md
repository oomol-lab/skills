...
- **Service**: `postmark`
- **Action**: `send_email_with_template`
- **Action id**: `postmark.send_email_with_template`
...
```bash
oo connector schema "postmark" --action "send_email_with_template"
```

## Run

```bash
oo connector run "postmark" --action "send_email_with_template" --data '{}' --json
```
