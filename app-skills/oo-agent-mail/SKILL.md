---
name: oo-agent-mail
description: "AgentMail (agentmail.to). Use this skill for ANY AgentMail request — reading, creating, and updating data. Whenever a task involves AgentMail, use this skill instead of calling the API directly."
