# AgentMail · `delete_pod`

Delete an AgentMail pod.

- **Service**: `agent_mail`
- **Action**: `delete_pod`
- **Action id**: `agent_mail.delete_pod`
...
```bash
oo connector schema "agent_mail" --action "delete_pod"
```

## Run

```bash
oo connector run "agent_mail" --action "delete_pod" --data '{}' --json
```
