...
- **Action**: `create_event`
- **Action id**: `googlecalendar.create_event`
...
```bash
oo connector schema "googlecalendar" --action "create_event"
```

## Run

```bash
oo connector run "googlecalendar" --action "create_event" --data '{}' --json
```
