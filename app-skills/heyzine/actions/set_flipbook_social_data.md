...
- **Service**: `heyzine`
- **Action**: `set_flipbook_social_data`
- **Action id**: `heyzine.set_flipbook_social_data`
...
```bash
oo connector schema "heyzine" --action "set_flipbook_social_data"
```

## Run

```bash
oo connector run "heyzine" --action "set_flipbook_social_data" --data '{}' --json
```
