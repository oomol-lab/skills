# LaunchDarkly · `patch_feature_flag`
...
- **Action id**: `launch_darkly.patch_feature_flag`
...
```bash
oo connector schema "launch_darkly" --action "patch_feature_flag"
```

## Run

```bash
oo connector run "launch_darkly" --action "patch_feature_flag" --data '{}' --json
```
