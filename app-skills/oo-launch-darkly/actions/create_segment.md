...
```bash
oo connector schema "launch_darkly" --action "create_segment"
```

## Run

```bash
oo connector run "launch_darkly" --action "create_segment" --data '{}' --json
```
