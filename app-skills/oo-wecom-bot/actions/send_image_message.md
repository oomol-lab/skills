...
```bash
oo connector schema "wecom_bot" --action "send_image_message"
```

## Run

```bash
oo connector run "wecom_bot" --action "send_image_message" --data '{}' --json
```
