...
- **Service**: `klangio`
- **Action**: `create_beat_tracking_job`
- **Action id**: `klangio.create_beat_tracking_job`
...
```bash
oo connector schema "klangio" --action "create_beat_tracking_job"
```

## Run

```bash
oo connector run "klangio" --action "create_beat_tracking_job" --data '{}' --json
```
