...
- **Service**: `klangio`
- **Action**: `create_chord_recognition_job`
- **Action id**: `klangio.create_chord_recognition_job`
...
```bash
oo connector schema "klangio" --action "create_chord_recognition_job"
```

## Run

```bash
oo connector run "klangio" --action "create_chord_recognition_job" --data '{}' --json
```
