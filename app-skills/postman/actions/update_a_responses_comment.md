...
- **Service**: `postman`
- **Action**: `update_a_responses_comment`
- **Action id**: `postman.update_a_responses_comment`
...
```bash
oo connector schema "postman" --action "update_a_responses_comment"
```

## Run

```bash
oo connector run "postman" --action "update_a_responses_comment" --data '{}' --json
```
