...
- **Service**: `postman`
- **Action**: `update_an_apis_comment`
- **Action id**: `postman.update_an_apis_comment`
...
```bash
oo connector schema "postman" --action "update_an_apis_comment"
```

## Run

```bash
oo connector run "postman" --action "update_an_apis_comment" --data '{}' --json
```
