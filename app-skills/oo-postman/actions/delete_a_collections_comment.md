...
- **Service**: `postman`
- **Action**: `delete_a_collections_comment`
- **Action id**: `postman.delete_a_collections_comment`
...
```bash
oo connector schema "postman" --action "delete_a_collections_comment"
```

## Run

```bash
oo connector run "postman" --action "delete_a_collections_comment" --data '{}' --json
```
