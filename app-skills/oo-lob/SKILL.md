...
metadata:
  ...
  version: "1.0.0"
  service: "lob"
  categories: "Marketing, Maps & Location"
...
Category: Marketing, Maps & Location. Exposes 5 action(s).
...
- [`autocomplete_us_addresses`](actions/autocomplete_us_addresses.md) — Return Lob US address autocomplete suggestions for a partial address.
- [`bulk_verify_international_addresses`](actions/bulk_verify_international_addresses.md) — Verify and standardize multiple international addresses with Lob Address Verification.
- [`bulk_verify_us_addresses`](actions/bulk_verify_us_addresses.md) — Verify and standardize multiple US addresses with Lob Address Verification.
- [`verify_international_address`](actions/verify_international_address.md) — Verify and standardize one international address with Lob Address Verification.
- [`verify_us_address`](actions/verify_us_address.md) — Verify and standardize one US address with Lob Address Verification.

## Safety

- Read actions (get / list / search) are safe to run directly.
- **Create, update, send, or post actions change Lob state — confirm the exact payload and effect with the user before running.**
