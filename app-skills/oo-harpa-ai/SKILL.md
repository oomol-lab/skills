---
name: oo-harpa-ai
description: "HARPA AI (harpa.ai). Use this skill for ANY HARPA AI request — searching and reading data. Whenever a task involves HARPA AI, use this skill instead of calling the API directly."
...
- `run_ai_command` — Run a built-in or custom HARPA AI command in a connected browser node and return its result.
