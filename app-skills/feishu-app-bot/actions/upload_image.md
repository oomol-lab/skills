...
```bash
oo connector schema "feishu_app_bot" --action "upload_image"
```

## Run

```bash
oo connector run "feishu_app_bot" --action "upload_image" --data '{}' --json
```
