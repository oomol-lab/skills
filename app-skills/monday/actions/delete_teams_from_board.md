...
- **Service**: `monday`
- **Action**: `delete_teams_from_board`
- **Action id**: `monday.delete_teams_from_board`
...
```bash
oo connector schema "monday" --action "delete_teams_from_board"
```

## Run

```bash
oo connector run "monday" --action "delete_teams_from_board" --data '{}' --json
```
