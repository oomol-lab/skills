...
```bash
oo connector schema "cloudlayer" --action "create_html_pdf_job"
```

## Run

```bash
oo connector run "cloudlayer" --action "create_html_pdf_job" --data '{}' --json
```
