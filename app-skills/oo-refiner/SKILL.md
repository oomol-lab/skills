...
- `add_contact_to_segment` — Add a Refiner contact to a manual segment. [write]
...
- **Actions tagged `[write]` change Refiner state — confirm the exact payload and effect with the user before running.**
