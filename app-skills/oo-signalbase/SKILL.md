...
- `list_acquisition_signals` — Fetch Signalbase acquisition signals with date, company, acquirer, amount, and sorting filters.
- `list_companies` — Browse and search Signalbase company profiles with pagination, filters, and sorting.
- `list_funding_signals` — Fetch Signalbase funding signals with date, company, investor, amount, and sorting filters.
- `list_hiring_signals` — Fetch Signalbase hiring signals with role, department, seniority, location, and sorting filters.
- `list_investors` — Fetch Signalbase investor data with type, location, ticket-size, and sorting filters.
- `list_job_change_signals` — Fetch Signalbase job-change signals with person, role, company, LinkedIn, and sorting filters.

## Safety

- Untagged actions are reads (get / list / search) — safe to run directly.
- **Actions tagged `[write]` change Signalbase state — confirm the exact payload and effect with the user before running.**
