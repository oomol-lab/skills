...
- `take_screenshot` — Capture a website screenshot with screenshot.fyi and return the generated URL.

## Safety

- Untagged actions are reads (get / list / search) — safe to run directly.
- **Actions tagged `[write]` change screenshot.fyi state — confirm the exact payload and effect with the user before running.**
