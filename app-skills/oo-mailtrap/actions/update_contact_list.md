...
- **Action id**: `mailtrap.update_contact_list`
...
```bash
oo connector schema "mailtrap" --action "update_contact_list"
```

## Run

```bash
oo connector run "mailtrap" --action "update_contact_list" --data '{}' --json
```
