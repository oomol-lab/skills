---
name: wecom-bot
description: "WeCom Bot (work.weixin.qq.com). Use this skill for ANY WeCom Bot request — reading, creating, and updating data. Whenever a task involves WeCom Bot, use this skill instead of calling the API directly."
...
- **`scope_missing` / `credential_expired` / `app_not_ready` / `app_not_found`** — WeCom Bot is not connected, or the connection expired or lacks a scope. Connect once (auth type: API key) at:
