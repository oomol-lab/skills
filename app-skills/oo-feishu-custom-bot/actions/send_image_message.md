...
```bash
oo connector schema "feishu_custom_bot" --action "send_image_message"
```

## Run

```bash
oo connector run "feishu_custom_bot" --action "send_image_message" --data '{}' --json
```
