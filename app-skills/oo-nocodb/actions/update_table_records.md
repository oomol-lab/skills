...
- **Service**: `nocodb`
- **Action**: `update_table_records`
- **Action id**: `nocodb.update_table_records`
...
```bash
oo connector schema "nocodb" --action "update_table_records"
```

## Run

```bash
oo connector run "nocodb" --action "update_table_records" --data '{}' --json
```
