...
- **Service**: `nocodb`
- **Action**: `create_table_records`
- **Action id**: `nocodb.create_table_records`
...
```bash
oo connector schema "nocodb" --action "create_table_records"
```

## Run

```bash
oo connector run "nocodb" --action "create_table_records" --data '{}' --json
```
