...
metadata:
  ...
  homepage: "https://bettercontact.rocks"
...
- [`get_account_balance`](actions/get_account_balance.md) — Get BetterContact credits for the connected account email or an optional email override.
- [`get_enrichment_result`](actions/get_enrichment_result.md) — Get the current BetterContact enrichment result for a submitted request ID.
- [`submit_enrichment`](actions/submit_enrichment.md) — Submit one or more leads to BetterContact waterfall enrichment and return the request handle.

## Safety

- Read actions (get / list / search) are safe to run directly.
- **Create, update, send, or post actions change BetterContact state — confirm the exact payload and effect with the user before running.**
