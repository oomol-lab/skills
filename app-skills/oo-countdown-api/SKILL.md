...
metadata:
  ...
  homepage: "https://countdownapi.com/"
...
- [`autocomplete`](actions/autocomplete.md) — Get eBay autocomplete suggestions for a search term through Countdown API.
- [`get_account`](actions/get_account.md) — Retrieve Countdown API account usage, quota, and platform status details.
- [`get_product`](actions/get_product.md) — Retrieve eBay product details by product ID through Countdown API.
- [`search_products`](actions/search_products.md) — Search eBay products through Countdown API with optional filters.

## Safety

- Read actions (get / list / search) are safe to run directly.
- **Create, update, send, or post actions change Countdown API state — confirm the exact payload and effect with the user before running.**
