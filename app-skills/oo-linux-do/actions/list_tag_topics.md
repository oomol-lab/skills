...
- **Service**: `linux_do`
- **Action**: `list_tag_topics`
- **Action id**: `linux_do.list_tag_topics`
...
```bash
oo connector schema "linux_do" --action "list_tag_topics"
```

## Run

```bash
oo connector run "linux_do" --action "list_tag_topics" --data '{}' --json
```
