...
- **Service**: `linux_do`
- **Action**: `list_category_topics`
- **Action id**: `linux_do.list_category_topics`
...
```bash
oo connector schema "linux_do" --action "list_category_topics"
```

## Run

```bash
oo connector run "linux_do" --action "list_category_topics" --data '{}' --json
```
