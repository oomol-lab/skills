...
```bash
oo connector schema "docker_hub" --action "remove_org_member"
```

## Run

```bash
oo connector run "docker_hub" --action "remove_org_member" --data '{}' --json
```
