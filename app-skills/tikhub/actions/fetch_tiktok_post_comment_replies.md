...
- **Service**: `tikhub`
- **Action**: `fetch_tiktok_post_comment_replies`
- **Action id**: `tikhub.fetch_tiktok_post_comment_replies`
...
```bash
oo connector schema "tikhub" --action "fetch_tiktok_post_comment_replies"
```

## Run

```bash
oo connector run "tikhub" --action "fetch_tiktok_post_comment_replies" --data '{}' --json
```
