...
- **Action id**: `clickup.create_task_from_template`
...
```bash
oo connector schema "clickup" --action "create_task_from_template"
```

## Run

```bash
oo connector run "clickup" --action "create_task_from_template" --data '{}' --json
```
