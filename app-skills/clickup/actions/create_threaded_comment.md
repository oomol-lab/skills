...
- **Service**: `clickup`
- **Action**: `create_threaded_comment`
- **Action id**: `clickup.create_threaded_comment`
...
```bash
oo connector schema "clickup" --action "create_threaded_comment"
```

## Run

```bash
oo connector run "clickup" --action "create_threaded_comment" --data '{}' --json
```
