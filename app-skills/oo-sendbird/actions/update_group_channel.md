...
- **Service**: `sendbird`
- **Action**: `update_group_channel`
- **Action id**: `sendbird.update_group_channel`
...
```bash
oo connector schema "sendbird" --action "update_group_channel"
```

## Run

```bash
oo connector run "sendbird" --action "update_group_channel" --data '{}' --json
```
