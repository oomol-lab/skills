...
```bash
oo connector schema "cal" --action "create_schedule"
```

## Run

```bash
oo connector run "cal" --action "create_schedule" --data '{}' --json
```
