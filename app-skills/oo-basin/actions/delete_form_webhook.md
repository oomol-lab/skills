...
- **Service**: `basin`
- **Action**: `delete_form_webhook`
- **Action id**: `basin.delete_form_webhook`
...
```bash
oo connector schema "basin" --action "delete_form_webhook"
```

## Run

```bash
oo connector run "basin" --action "delete_form_webhook" --data '{}' --json
```
