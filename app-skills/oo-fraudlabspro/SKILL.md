---
name: oo-fraudlabspro
description: "FraudLabs Pro (fraudlabspro.com). Use this skill for ANY FraudLabs Pro request — reading, creating, and updating data. Whenever a task involves FraudLabs Pro, use this skill instead of calling the API directly."
...
- **Actions tagged `[write]` change FraudLabs Pro state — confirm the exact payload and effect with the user before running.**
