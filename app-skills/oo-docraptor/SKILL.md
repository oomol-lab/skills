...
- `create_hosted_document` — Create a hosted PDF or Excel document with DocRaptor from raw HTML or a public URL and return its download URL. [write]

## Safety

- Untagged actions are reads (get / list / search) — safe to run directly.
- **Actions tagged `[write]` change DocRaptor state — confirm the exact payload and effect with the user before running.**
