...
```bash
oo connector schema "qianfan" --action "create_chat_completion"
```

## Run

```bash
oo connector run "qianfan" --action "create_chat_completion" --data '{}' --json
```
