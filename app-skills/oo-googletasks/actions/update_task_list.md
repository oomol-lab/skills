...
```bash
oo connector schema "googletasks" --action "update_task_list"
```

## Run

```bash
oo connector run "googletasks" --action "update_task_list" --data '{}' --json
```
