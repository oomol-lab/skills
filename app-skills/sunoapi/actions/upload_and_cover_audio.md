...
- **Service**: `sunoapi`
- **Action**: `upload_and_cover_audio`
- **Action id**: `sunoapi.upload_and_cover_audio`
...
```bash
oo connector schema "sunoapi" --action "upload_and_cover_audio"
```

## Run

```bash
oo connector run "sunoapi" --action "upload_and_cover_audio" --data '{}' --json
```
