...
- **Service**: `spotify`
- **Action**: `remove_user_s_saved_audiobooks`
- **Action id**: `spotify.remove_user_s_saved_audiobooks`
...
```bash
oo connector schema "spotify" --action "remove_user_s_saved_audiobooks"
```

## Run

```bash
oo connector run "spotify" --action "remove_user_s_saved_audiobooks" --data '{}' --json
```
