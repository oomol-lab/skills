...
- **Service**: `spotify`
- **Action**: `remove_user_s_saved_tracks`
- **Action id**: `spotify.remove_user_s_saved_tracks`
...
```bash
oo connector schema "spotify" --action "remove_user_s_saved_tracks"
```

## Run

```bash
oo connector run "spotify" --action "remove_user_s_saved_tracks" --data '{}' --json
```
